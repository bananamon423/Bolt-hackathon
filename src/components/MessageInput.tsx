      ...
      <form onSubmit={handleSubmit} className="flex gap-3">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`w-14 h-14 text-white rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center gap-2 ${
              isAIMessage
                ? 'bg-purple-500 border-2 border-purple-700 focus:ring-purple-200'
                : 'bg-purple-500 border-2 border-purple-700 focus:ring-purple-200'
            }`}
          >
            {isLoading || isSending ? (
          ...
          <button
            ...
            className={`w-14 h-14 flex items-center justify-center text-white rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center gap-2 ${
              isAIMessage
                ? 'bg-purple-500 border-2 border-purple-700 focus:ring-purple-200'
