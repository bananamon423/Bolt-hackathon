...
This migration fixes the database functions and policies by properly handling existing objects
and ensuring all dependencies are correctly managed.

## Changes Made:
1. Drop all dependent policies first
2. Recreate functions with correct parameter names
3. Recreate all policies with proper function references
